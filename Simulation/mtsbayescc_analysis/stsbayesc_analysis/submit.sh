...
scriptPath="/common/zhao/jyqqu/MTSBayesCC/analysis/sim_chr1_output_v2/STS/STSBayesC/h2_0.1_pi0.9/"
logPath="${scriptPath}/log_folder/"
mkdir -p ${logPath}

scriptName="step3_STSBayesC_Sim2Tfunc.jl"
...
do
    ...
    do
        ...
        #do
		    ...
		    printLog="${logPath}/${qsubName}_trait${trait}.log"
                    jobFile="${logPath}/${qsubName}_trait${trait}.sh"
                    # if [ ! -f "/common/zhao/tianjing/simu_ch1_res/mt_s_bayesc_c_priorsimu/${qsubName}/estGcor_total.txt" ]; then
                        ...
                        echo "#SBATCH --time=99:00:00" >> $jobFile  # Adjust time as necessary
			...
			echo "module load julia" >> $jobFile
                        echo "srun julia --project=/common/zhao/jyqqu/mtsbayescc ${scriptPath}/${scriptName} \
                              ...
                              --outfreq ${outfreq} \
			      --trait ${trait} \
			      --analysis_folder ${scriptPath} > ${printLog}" >> $jobFile
