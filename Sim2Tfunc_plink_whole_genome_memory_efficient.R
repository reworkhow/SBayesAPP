...
rawDataPath <- paste0("path_to_folder_saving_UKBB_bfiles") # Folder containing the UKBB bfiles
outPath <- paste0("/home/uqjzeng1/wd/proj/TJ/sim_whole_genome_output/") # Folder to save simulation results
rawBimFileSuffix <- paste0("prefix_of_bfiles") # Prefix of the bim/bed/fam file
outPath <- paste0(outPath, "rep", seed, "hsq", h21, "-", h22, "pleioPercent", pleio_percent, "_sampleSize", sample_size, "_annotationSize", annotation_size, "/")
